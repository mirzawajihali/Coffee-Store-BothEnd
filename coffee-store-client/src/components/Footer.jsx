...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-r from-[#1A120B] to-[#3C2A21]  mt-10 lg:grid lg:grid-cols-5">
        <div className="relative block  lg:col-span-2 h-full">
          <img
            src="https://i.pinimg.com/736x/fc/ca/58/fcca58ec64e1e95d92457315061ce185.jpg"
            alt=""
